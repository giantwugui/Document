define("focusClipperButton", ["react","stringAffixer"], function(__WEBPACK_EXTERNAL_MODULE_8__, __WEBPACK_EXTERNAL_MODULE_23__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/less-loader/index.js?{\"relativeUrls\":false}!./clipperButton.less", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/less-loader/index.js?{\"relativeUrls\":false}!./clipperButton.less");
...
var _clipperIcon = __webpack_require__(246);

var _clipperIcon2 = _interopRequireDefault(_clipperIcon);

__webpack_require__(261);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var cssPrefixed = (0, _stringAffixer.getCssPrefixer)('FocusClipperButton');

/**
 * A green text button with a clipper icon inside of it, positioned left of the text.
 */
function ClipperButton(props) {
  var clipperSvgDangerousHtml = { __html: _clipperIcon2.default };

  return _react2.default.createElement(
    'div',
    { onClick: props.onClick, className: cssPrefixed('button') },
    _react2.default.createElement('div', {
      className: cssPrefixed('clipper-icon'),
      dangerouslySetInnerHTML: clipperSvgDangerousHtml
    }),
    _react2.default.createElement(
      'div',
      { className: cssPrefixed('text') },
      _i18n2.default.localize('Focus.clipperButton.webClipper')
    )
  );
}

ClipperButton.propTypes = {
