define("focusFleTooltip", ["react","jquery","react-dom","enPropTypes"], function(__WEBPACK_EXTERNAL_MODULE_8__, __WEBPACK_EXTERNAL_MODULE_85__, __WEBPACK_EXTERNAL_MODULE_96__, __WEBPACK_EXTERNAL_MODULE_277__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
module.exports = "/web-frontend/9d8e5c776f4315697e3d25189a40a651.png";
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/less-loader/index.js?{\"relativeUrls\":false}!./fleTooltip.less", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/less-loader/index.js?{\"relativeUrls\":false}!./fleTooltip.less");
...
module.exports = "/web-frontend/db7e46943138d2897e5148ef933f8149.png";
...
var _enPropTypes = __webpack_require__(277);

var _enPropTypes2 = _interopRequireDefault(_enPropTypes);
...
var ARROW_WIDTH = 15;
var ARROW_OFFSET_FROM_SIDE = 30;
var CONTAINER_WIDTH = 564;
var TRANSITION_DELAY = 300;

/**
 * The position of the arrow on the tooltip. The first word specifies the side, and the
 * second word specifies the area on that side.
 */
var ArrowPosition = {
  LEFT_MIDDLE: 1,
  TOP_LEFT: 2,
...
var ArrowPositionProperties = (_ArrowPositionPropert = {}, _defineProperty(_ArrowPositionPropert, ArrowPosition.LEFT_MIDDLE, {
  className: 'FleTooltip-container-left-middle',
  xOffset: function xOffset() {
    return ARROW_WIDTH;
  },
  yOffset: function yOffset(height) {
    return -height / 2;
  }
}), _defineProperty(_ArrowPositionPropert, ArrowPosition.TOP_LEFT, {
  className: 'FleTooltip-container-top-left',
  xOffset: function xOffset() {
    return -(ARROW_WIDTH + ARROW_OFFSET_FROM_SIDE);
  },
  yOffset: function yOffset() {
    return ARROW_WIDTH;
  }
}), _defineProperty(_ArrowPositionPropert, ArrowPosition.BOTTOM_LEFT, {
  className: 'FleTooltip-container-bottom-left',
  xOffset: function xOffset() {
    return -(ARROW_WIDTH + ARROW_OFFSET_FROM_SIDE);
  },
  yOffset: function yOffset(height) {
    return -(height + ARROW_WIDTH);
  }
}), _defineProperty(_ArrowPositionPropert, ArrowPosition.LEFT_TOP, {
  className: 'FleTooltip-container-left-top',
  xOffset: function xOffset() {
    return ARROW_WIDTH;
  },
  yOffset: function yOffset() {
...
}), _defineProperty(_ArrowPositionPropert, ArrowPosition.TOP_RIGHT, {
  className: 'FleTooltip-container-top-right',
  xOffset: function xOffset() {
    return ARROW_WIDTH + ARROW_OFFSET_FROM_SIDE - CONTAINER_WIDTH;
  },
  yOffset: function yOffset() {
    return ARROW_WIDTH;
  }
}), _ArrowPositionPropert);

/**
 * A component that renders an FLE tooltip with an arrow, a subheading and some text.
 */

var FleTooltip = function (_React$Component) {
  _inherits(FleTooltip, _React$Component);

  function FleTooltip(props) {
    _classCallCheck(this, FleTooltip);

    var _this = _possibleConstructorReturn(this, (FleTooltip.__proto__ || Object.getPrototypeOf(FleTooltip)).call(this, props));

    _this.boundGlobalClickHideHandler = _this.globalClickHideHandler.bind(_this);
    var initialXPosition = props.xPosition;
    var initialYPosition = props.yPosition;
    _this.state = {
      hidden: true,
  ...
  _createClass(FleTooltip, [{
    ...
    value: function componentDidMount() {
      ...
      (0, _jquery2.default)(document.body).on('click touchstart', this.boundGlobalClickHideHandler);
    }
  }, {
    key: 'componentWillUnmount',
    value: function componentWillUnmount() {
      (0, _jquery2.default)(document.body).off('click touchstart', this.boundGlobalClickHideHandler);
    }
    ...
    /**
     * Returns the css class applied to the container which causes the correct arrow to
     * render, based on the arrowPosition prop.
     */

  }, {
    key: 'getArrowClass',
    value: function getArrowClass() {
      return ArrowPositionProperties[this.props.arrowPosition].className;
    }
  }, {
    key: 'globalClickHideHandler',
    value: function globalClickHideHandler(e) {
      if (!this.isTooltipEventTarget(e)) {
        this.closeTooltip();
      }
    }
  }, {
    key: 'isTooltipEventTarget',
    value: function isTooltipEventTarget(e) {
      return !!(0, _jquery2.default)(e.target).closest(_reactDom2.default.findDOMNode(this)).length;
    }

    /**
     * Gets the tooltip's offset height - can be mocked for testing, since offsetHeight is
     * a read-only property.
     */

  }, {
    key: 'getTooltipHeight',
    value: function getTooltipHeight() {
      return _reactDom2.default.findDOMNode(this).offsetHeight;
    }

    /**
     * Moves the tooltip to the correct position, based on the arrowPosition prop.
     */
    ...
    value: function positionTooltip() {
      ...
      var height = this.getTooltipHeight();
      xPosition += ArrowPositionProperties[this.props.arrowPosition].xOffset(height);
      yPosition += ArrowPositionProperties[this.props.arrowPosition].yOffset(height);
      this.setState({
        xPosition: xPosition,
        yPosition: yPosition
      });
    ...
    value: function render() {
      ...
      var transitionDurationSeconds = TRANSITION_DELAY / 1000 + 's';
      var arrowClass = this.getArrowClass();
      var containerStyle = {
      ...
      var containerClasses = (0, _classnames2.default)({
        'FleTooltip-container': true,
        'FleTooltip-container-hidden': this.state.hidden
      }, arrowClass);
      return _react2.default.createElement(
        'div',
        {
          key: this.props.subheadingKey,
          style: containerStyle,
          className: containerClasses
        },
        _react2.default.createElement(
          'p',
          { className: 'FleTooltip-Text' },
          _react2.default.createElement(
            'span',
            { className: 'FleTooltip-Text_emphasized' },
            _i18n2.default.localize(this.props.subheadingKey)
          ),
          _react2.default.createElement(
            'span',
            null,
            _i18n2.default.localize(this.props.textKey)
          )
        ),
        _react2.default.createElement('i', { className: 'FleTooltip-Icon_close', onClick: function onClick() {
...
FleTooltip.propTypes = {
  arrowPosition: _enPropTypes2.default.objectPropertyValue(ArrowPosition).isRequired, // arrow position
  subheadingKey: _react2.default.PropTypes.string.isRequired, // the i18n key for the subheading
  textKey: _react2.default.PropTypes.string.isRequired, // the i18n key for the text
  xPosition: _react2.default.PropTypes.number.isRequired, // x position where the arrow points
  yPosition: _react2.default.PropTypes.number.isRequired };
FleTooltip.ARROW_OFFSET_FROM_SIDE = ARROW_OFFSET_FROM_SIDE;
FleTooltip.ARROW_WIDTH = ARROW_WIDTH;
FleTooltip.CONTAINER_WIDTH = CONTAINER_WIDTH;
FleTooltip.TRANSITION_DELAY = TRANSITION_DELAY;
FleTooltip.ArrowPosition = ArrowPosition;
exports.default = FleTooltip;
module.exports = exports['default'];
