define("focusNewUserIncentiveDialog", ["react","stringAffixer"], function(__WEBPACK_EXTERNAL_MODULE_8__, __WEBPACK_EXTERNAL_MODULE_23__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
// Incentive values taken from NewUserIncentiveFirstLaunchVariant#getPromoType.
var INCENTIVE_SAVINGS = exports.INCENTIVE_SAVINGS = '15_percent_savings';
var INCENTIVE_TRIAL = exports.INCENTIVE_TRIAL = '7_day_trial';
...
module.exports = "/web-frontend/e17732b17ada4031fadc6cb2a6b4c7b3.png";
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/less-loader/index.js?{\"relativeUrls\":false}!./newUserIncentiveDialog.less", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/less-loader/index.js?{\"relativeUrls\":false}!./newUserIncentiveDialog.less");
...
module.exports = "/web-frontend/38430feb6a357d2e28726187a5f16454.png";
...
exports.default = NewUserIncentiveDialog;

var _react = __webpack_require__(8);

var _react2 = _interopRequireDefault(_react);

var _newUserIncentiveConstants = __webpack_require__(128);
...
var cssPrefixed = (0, _stringAffixer.getCssPrefixer)('FocusNewUserIncentiveDialog');

/**
 * A dialog that upsells premium with a possible incentive. Used in an experiment tracked
 * by WEB-47732.
 */
function NewUserIncentiveDialog(props) {
  function getHeadingCopy() {
    if (props.incentive === _newUserIncentiveConstants.INCENTIVE_SAVINGS) {
      return props.firstLaunch ? _i18n2.default.localize('Focus.newUserIncentiveDialog.heading.getPremiumDiscount') : _i18n2.default.localize('Focus.newUserIncentiveDialog.heading.saveOnPremium');
    } else {
      return _i18n2.default.localize('Focus.newUserIncentiveDialog.heading.tryPremium');
    }
  }

  function getBodyCopy() {
    if (props.incentive === _newUserIncentiveConstants.INCENTIVE_TRIAL) {
      return props.firstLaunch ? _i18n2.default.localize('Focus.newUserIncentiveDialog.body.playWithFeatures') : _i18n2.default.localize('Focus.newUserIncentiveDialog.body.moreSpace');
    } else if (props.incentive === _newUserIncentiveConstants.INCENTIVE_SAVINGS) {
      return props.firstLaunch ? _i18n2.default.localize('Focus.newUserIncentiveDialog.body.moreSpace') : _i18n2.default.localize('Focus.newUserIncentiveDialog.body.getMoreDone');
    } else {
      return _i18n2.default.localize('Focus.newUserIncentiveDialog.body.moreSpace');
    }
  }

  function getButtonCopy() {
    if (props.incentive === _newUserIncentiveConstants.INCENTIVE_TRIAL) {
      return _i18n2.default.localize('Focus.newUserIncentiveDialog.button.trial');
    } else if (props.incentive === _newUserIncentiveConstants.INCENTIVE_SAVINGS) {
      return _i18n2.default.localize('Focus.newUserIncentiveDialog.button.savings');
    } else {
      return _i18n2.default.localize('Focus.newUserIncentiveDialog.button.upgrade');
    }
  }

  var closeSvgDangerousHtml = { __html: _closeIcon2.default };
  return _react2.default.createElement(
    'div',
    { className: cssPrefixed('container') },
    _react2.default.createElement('div', { className: cssPrefixed('illustration') }),
    ...
    _react2.default.createElement(
      'div',
      { className: cssPrefixed('button-container') },
      _react2.default.createElement(
        'div',
        { className: cssPrefixed('button'), onClick: props.onCta },
        getButtonCopy()
      )
    ),
    _react2.default.createElement('div', {
      className: cssPrefixed('close-icon'),
      onClick: props.onClose,
      dangerouslySetInnerHTML: closeSvgDangerousHtml
    })
  );
}

NewUserIncentiveDialog.propTypes = {
  firstLaunch: _react2.default.PropTypes.bool.isRequired,
  incentive: _react2.default.PropTypes.oneOf([_newUserIncentiveConstants.INCENTIVE_TRIAL, _newUserIncentiveConstants.INCENTIVE_SAVINGS]),
  onClose: _react2.default.PropTypes.func.isRequired,
  onCta: _react2.default.PropTypes.func.isRequired
};
module.exports = exports['default'];
